...
//$sql = 'SELECT * FROM baidang, phong, hinhanh where baidang.maPhong = phong.maPhong and phong.maPhong = hinhanh.Phong';
 $sql="SELECT * FROM  baidang, phong,loaiphong where baidang.tinhtrang = 2 and baidang.maPhong=phong.maPhong and phong.maloaiPhong = loaiphong.maloaiPhong  and phong.maloaiPhong=3";
