<?php
$id = $_SESSION['user']['id'];
$qr_hd = "SELECT * from hopdong where hopdong.khachhang = '$id' and Tinhtranghopdong = 1";
            ...
            while ($hopdong = mysqli_fetch_array($hopdongs)) {
                ...
                <tr>
                    ...
                    <td colspan="2"  style="border: none; padding: 5px 10px; width: 100px; text-align: left; margin: 0px;">
                        <?php $nd = strtotime($hopdong['ngaydat']); echo date("d-m-yy", $nd); ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr style="border-bottom: .5px solid #EEE;">
                    <td colspan="3">
