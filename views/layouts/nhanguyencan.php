...
//$sql = 'SELECT * FROM baidang, phong, hinhanh where baidang.maPhong = phong.maPhong and phong.maPhong = hinhanh.Phong';
 $sql="SELECT * FROM  baidang, phong,loaiphong where baidang.tinhtrang = 2 and 
    baidang.maPhong=phong.maPhong and phong.maloaiPhong = loaiphong.maloaiPhong  and phong.maloaiPhong=2";
    ...
    <div class="col-lg-4 col-md-6" style="margin-bottom: 20px;">
        <div class="hp-room-item set-bg" data-setbg="../upload/<?php echo $row['hinh']; ?>">
            <div class="hr-text">
                ...
                <h2><?php echo number_format($row['giathue'],0,",",".");?><span>/Giá</span></h2>
