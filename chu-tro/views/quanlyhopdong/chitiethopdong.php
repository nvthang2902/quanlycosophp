...
<?php
$mahd = $_REQUEST['mahd'];
$qr_hd = "SELECT * from hopdong, khachhang where maHD = '$mahd' and hopdong.khachhang = khachhang.maKh";
...
<div class="container">
        ...
        <table style="text-align: left; widows: 100%;">
            ...
            while ($hopdong = mysqli_fetch_array($hopdongs)) {
                ...
                <tr>
                    <td colspan="4" style="text-align: right; padding: 5px 50px; border-bottom: .5px solid #DDD;">
                        <a href="../../handlers/hd-huyphong.php?key=xl&hd=<?php echo $hopdong['maHD']; ?>">Chấp nhận</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
